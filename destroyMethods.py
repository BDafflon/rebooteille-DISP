...
def destroy_random(solution, degres_destruction):
    ...
    FR :
    Opérateur de destruction aléatoire d'un nombre de clients donné par le degrès de destruction
    ...
    #Calcul du nombre de client à détruire
...
def destroy_Client_with_a_high_ratio_placed_at_the_end_of_the_solution(solution, degres_destruction):
    ...
    #Tant qu'on a pas détruit toutes les clients demandés on recommence
