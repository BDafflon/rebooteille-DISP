...
def parsingDistance(filePath, sheetName):
    ...
    # Recuperation du nombre de lignes et de colonnes
...
def parseForALNS(fileDataPath, dataSheetName="Data", fileDistPath="./data/MatricesDT.xlsx", distSheetName="Distance"):
    ...
    # Récupération du nombre de clients à traiter
    ...
    return Instance(listClient, listVehicle, numberTimeSlotMax, routePerTimeSlotMax, durationTimeSlotMax, timeTravel,
                    name)
